...
GUI_CFLAGS = -Wall -O2 $(shell gtk-config --cflags) -I/opt/audio/include -I$(FLUID_INCLUDE) -I$(FLUID_SRC)
...
#DARWIN_EXTRA_PLUGIN_CFLAGS = $(DARWIN_EXTRA_CFLAGS) -I$(FLUID_INCLUDE) -I$(FLUID_SRC)
#OPTIMIZATION_CFLAGS = -O2 -s -fomit-frame-pointer -funroll-all-loops -ffast-math -finline-functions -finline-limit=5000 -Winline
#PLUGIN_CFLAGS = -fno-common -Wall -I. $(DARWIN_EXTRA_PLUGIN_CFLAGS) -I$(FLUID_INCLUDE) -I$(FLUID_SRC) $(OPTIMIZATION_CFLAGS)
