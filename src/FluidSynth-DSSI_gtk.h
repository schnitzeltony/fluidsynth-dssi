...
/* NOTE: I've examined the FluidSynth v1.0.5 code, and don't see any incompatibilities
 * with FluidSynth-DSSI.  I have not yet actually tested v1.0.5.  -Sean Bolton 11/9/2004 */
